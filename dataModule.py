...
class X10v2DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        rf = robjects.r['load'](self.data_dir + "/" + self.data_name + "/10Xv2_pbmc1_folds.RData")
        ...
        train_idx, val_idx = train_test_split(train_idx, train_size=0.8, stratify=full_labels[train_idx])
...
class CelSeqDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir: str = './data', batch_size=64, num_workers=2):
        ...
        self.batch_size = batch_size
        self.num_workers = num_workers
        self.data_name = "CEL-Seq"
        self.label_mapping = None
        self.testing_idx = (19481, 19754)

    def prepare_data(self):
        # download
        if not os.path.exists(f"{self.data_dir}/{self.data_name}"):
          print("Start downloading CEL-Seq!")
          url = 'https://github.com/Aprilhuu/Deep-Learning-in-Single-Cell-Analysis/raw/main/CEL-Seq.zip'
          download_and_extract_archive(url, f"{self.data_dir}", f"{self.data_dir}", filename=self.data_name + '.zip')

    def setup(self, stage):
        DataPath = self.data_dir + "/" + self.data_name + "/CL_pbmc1.csv"
        LabelsPath = self.data_dir + "/" + self.data_name + "/CL_pbmc1Labels.csv"
        rf = robjects.r['load'](self.data_dir + "/" + self.data_name + "/CL_pbmc1_folds.RData")
...
class DropSeqDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self):
        # download
        if not os.path.exists(f"{self.data_dir}/{self.data_name}"):
          print("Start downloading Drop-Seq!")
          url = 'https://github.com/Aprilhuu/Deep-Learning-in-Single-Cell-Analysis/raw/main/Drop-Seq.zip'
          download_and_extract_archive(url, f"{self.data_dir}", f"{self.data_dir}", filename=self.data_name + '.zip')

    def setup(self, stage):
        DataPath = self.data_dir + "/" + self.data_name + "/DR_pbmc1.csv"
        LabelsPath = self.data_dir + "/" + self.data_name + "/DR_pbmc1Labels.csv"

        rf = robjects.r['load'](self.data_dir + "/" + self.data_name + "/DR_pbmc1_folds.RData")
...
class InDropDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir: str = './data', batch_size=64, num_workers=2):
        ...
        self.batch_size = batch_size
        self.num_workers = num_workers
        self.data_name = "inDrop"
        self.label_mapping = None
        self.testing_idx = (18765, 21832)

    def prepare_data(self):
        # download
        if not os.path.exists(f"{self.data_dir}/{self.data_name}"):
          print("Start downloading inDrop!")
          url = 'https://github.com/Aprilhuu/Deep-Learning-in-Single-Cell-Analysis/raw/main/inDrop.zip'
          download_and_extract_archive(url, f"{self.data_dir}", f"{self.data_dir}", filename=self.data_name + '.zip')

    def setup(self, stage):
        DataPath = self.data_dir + "/" + self.data_name + "/iD_pbmc1.csv"
        LabelsPath = self.data_dir + "/" + self.data_name + "/iD_pbmc1Labels.csv"

        rf = robjects.r['load'](self.data_dir + "/" + self.data_name + "/iD_pbmc1_folds.RData")
...
class SeqWellDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir: str = './data', batch_size=64, num_workers=2):
        ...
        self.batch_size = batch_size
        self.num_workers = num_workers
        self.data_name = "Seq-Well"
        self.label_mapping = None
        self.testing_idx = (18415, 18966)

    def prepare_data(self):
        # download
        if not os.path.exists(f"{self.data_dir}/{self.data_name}"):
          print("Start downloading Seq-Well!")
          url = 'https://github.com/Aprilhuu/Deep-Learning-in-Single-Cell-Analysis/raw/main/Seq-Well.zip'
          download_and_extract_archive(url, f"{self.data_dir}", f"{self.data_dir}", filename=self.data_name + '.zip')

    def setup(self, stage):
        DataPath = self.data_dir + "/" + self.data_name + "/SW_pbmc1.csv"
        LabelsPath = self.data_dir + "/" + self.data_name + "/SW_pbmc1Labels.csv"

        rf = robjects.r['load'](self.data_dir + "/" + self.data_name + "/SW_pbmc1_folds.RData")
...
class SmartSeq2DataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir: str = './data', batch_size=64, num_workers=2):
        ...
        self.batch_size = batch_size
        self.num_workers = num_workers
        self.data_name = "Smart-Seq2"
        self.label_mapping = None
        self.testing_idx = (18663, 18886)

    def prepare_data(self):
        # download
        if not os.path.exists(f"{self.data_dir}/{self.data_name}"):
          print("Start downloading Smart-Seq2!")
          url = 'https://github.com/Aprilhuu/Deep-Learning-in-Single-Cell-Analysis/raw/main/Smart-Seq2.zip'
          download_and_extract_archive(url, f"{self.data_dir}", f"{self.data_dir}", filename=self.data_name + '.zip')

    def setup(self, stage):
        DataPath = self.data_dir + "/" + self.data_name + "/SM2_pbmc1.csv"
        LabelsPath = self.data_dir + "/" + self.data_name + "/SM2_pbmc1Labels.csv"

        rf = robjects.r['load'](self.data_dir + "/" + self.data_name + "/SM2_pbmc1_folds.RData")
